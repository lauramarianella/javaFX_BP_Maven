 ...
 * @author laura
 */
public class _14_13_ShowHBoxVBox extends Application {
  ...
  private HBox getHBox() {
    ...
    ImageView imageView = new ImageView(new Image("https://upload.wikimedia.org/wikipedia/commons/3/39/Animated-Flag-Canada.gif"));
