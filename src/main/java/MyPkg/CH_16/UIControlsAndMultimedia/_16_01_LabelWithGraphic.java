 ...
 * @author laura
 */
public class _16_01_LabelWithGraphic extends Application {
  @Override // Override the start method in the Application class
  public void start(Stage primaryStage) {
    ImageView image = new ImageView(new Image("https://upload.wikimedia.org/wikipedia/commons/3/39/Animated-Flag-Canada.gif"));
    Label lb1 = new Label("Canada\n Flag", image);
